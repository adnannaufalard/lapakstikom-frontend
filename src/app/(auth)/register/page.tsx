...
function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Store in sessionStorage and redirect to onboarding
  ...
  return (
    <div className="h-screen bg-blue-500 flex overflow-hidden">
        ...
        <div className="w-full max-w-sm h-full flex items-center">
          <div className="bg-white rounded-3xl shadow-2xl p-7 w-full my-auto">
            ...
            <div className="mb-5 text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">Masukkan email dan password untuk memulai</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-center mt-2">
                  <Link href="/ukm/register" className="text-blue-500 hover:text-blue-600 font-semibold text-sm">
                    Daftar UKM
                  </Link>
                </p>
                ...
                <p className="text-center text-xs text-gray-500 mt-3 leading-relaxed">
                  Dengan Sign Up, kamu menyetujui{' '}
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col p-6 text-white">
        ...
        <div className="flex-1 flex flex-col justify-start pt-8 items-end max-w-lg ml-auto">
          {/* Illustration */}
          <div className="mb-6">
